...
POST /api/v5/{ts}/trends
  Body (JSON): {metric, params, last_n}
...
Groups by commit only (no machine grouping).
"""
...
from ..helpers import dump_response, format_utc, get_metric_def
...
class TrendsView(MethodView):
    ...
    def post(self, query_args, testsuite):
        ...
        Returns trend data points grouped by commit with the geometric
        mean of all positive sample values within each group.  Only
